...
// General Styles
const generalStyles = [
  "transition duration-200 border uppercase shadow-sm inline-flex items-center justify-center py-2 px-3 rounded-md cursor-pointer",
...
<template>
  <component :is="as" v-bind="{ ...attrs, class: computedClass }">
    <slot></slot>
  </component>
</template>
